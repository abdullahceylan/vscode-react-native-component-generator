...
export function activate(context: ExtensionContext) {
    ...
    const createComponent = (uri, suffix: string = '') => {
        ...
        enterComponentNameDialog$
            ...
            .subscribe(
                (c) => logger('success', 'React Native component successfully created!'),
                err => logger('error', err.message)
            );
    };

    const componentArray = [
        { type: "container", commandId: 'extension.genReactNativeContainerComponentFiles' },
        { type: "stateless", commandId: 'extension.genReactNativeStatelessComponentFiles' },
        { type: "reduxContainer", commandId: 'extension.genReactNativeReduxContainerComponentFiles' },
        { type: "reduxStateless", commandId: 'extension.genReactNativeReduxStatelessComponentFiles' },
    ];
